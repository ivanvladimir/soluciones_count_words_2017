...
for linea in archivo:
    ...
    for palabra in palabras:
        c+=1
        palabra = palabra.strip(".,") # quitar puntuwación
...
print('\n')
print('Total de palabras sin repeticiones:', len(contador))
print('Total de palabras con repeticiones:', c)
print('Las',argumento.n,'  palabras más comunes son:')
print('\n')
for palabra in sorted( contador, key = contador.get, reverse=True )[:argumento.n]:
    print('  ',palabra,':',contador[palabra],'veces encontradas')
